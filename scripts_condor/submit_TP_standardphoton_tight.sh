...
do
	...
	do
		...
		echo "Arguments = ${analyzer}_${TP_tag}_${sample}_Job${jobnumber}_Of_${maxjob} /store/group/phys_susy/razor/Run2Analysis/TagAndProbe/${TP_tag}/2016/jobs ${analyzer} ${inputfilelist} yes 30105 ${filesPerJob} ${jobnumber} ${sample}_Job${jobnumber}_Of_${maxjob}.root" >> ${jdl_file}
