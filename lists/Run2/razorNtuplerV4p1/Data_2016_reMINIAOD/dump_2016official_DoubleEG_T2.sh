...
do
	echo 'xxxxxxxxxx' > DoubleEG_${run}_25Mar2019.caltech.txt
	subBase1=${baseDir}crab_prod_CaltechT2_Run2RazorNtuplerV4p1_DoubleEG_${run}_ReMiniAOD2016Official_v1_25Mar2019/
	echo ${subBase1}
	...
	do
		...
		do
			...
			do
				echo "${subBase3}${ifile}" >> DoubleEG_${run}_25Mar2019.caltech.txt
			done
		done
	done
	sed -i '/xxxxxxxxxx/d' DoubleEG_${run}_25Mar2019.caltech.txt
done
